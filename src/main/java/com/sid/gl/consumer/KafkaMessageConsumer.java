...
public class KafkaMessageConsumer {
    ...
    @RetryableTopic(attempts = "4") //default 3 topic n-1
    @KafkaListener(topics = "${app.topic.name}", groupId = "houleye-group")
    ...
    public void listenDLT(User user,
      ...
      log.info("DLT received: {} , from {}, offset {} ",user.getFirstName(),
              topic,offset);
